...
namespace NWH.DWP2.ShipController
{
    ...
    /// </summary>
    public class PadeloInputController : ShipInputProvider
    {
        public ShipInputActions shipInputActions;
        public TcpTest tcpTest;
        ...
        public void Update()
        {
            ...
            if(tcpTest.moving==true)
            _throttle = (float)tcpTest.speed / 200;
...
namespace NWH.DWP2.WaterObjects
{
    ...
    public class PadeloInputController : DWP_NUIEditor
    {
