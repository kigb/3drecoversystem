...
namespace NWH.DWP2.ShipController
{
    ...
    /// </summary>
    public class RowingInputSystemShipInputProvider : ShipInputProvider
    {
        ...
        public void Update()
        {
            ...
            _steering = manualController._xAxis;
            _throttle = shipInputActions.ShipControls.Throttle.ReadValue<float>();
            _throttle = manualController._yAxis;
...
namespace NWH.DWP2.WaterObjects
{
    ...
    public class RowingInputSystemShipInputProviderEditor : DWP_NUIEditor
    {
